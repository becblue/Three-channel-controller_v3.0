/**
  ...
  * @attention
  * 
  * 本模块实现IWDG独立看门狗功能，为高安全性的工业控制系统提供可靠的
  * 系统复位保护。主要特性：
  * 1. 7秒超时时间，适合工业控制应用
  * 2. 智能喂狗机制，只在系统正常时喂狗
  * 3. 与安全监控系统集成，异常时停止喂狗
...
// 看门狗配置参数
#define IWDG_TIMEOUT_MS         7000        // 超时时间：7秒
#define IWDG_FEED_INTERVAL_MS   500         // 喂狗间隔：500ms
#define IWDG_PRESCALER          IWDG_PRESCALER_256  // 预分频器：256
#define IWDG_RELOAD_VALUE       1093        // 重装载值：1093 (7秒超时)
